...
func FlyURL() string {
	return "https://aryamulyakusuma-final-project-be2634183.fly.dev" // TODO: replace this
}

func main() {
	//TODO: hapus jika sudah di deploy di fly.io
	var _ = os.Setenv("DATABASE_URL", "postgres://postgres:ga123124@localhost:5432/final_web_app")
